...
package_dir = get_package_share_directory('autonomous_exploration')

params_file_path = os.path.join(package_dir, 'params.yaml')
...
def exploration(data,width,height,resolution,column,row,originX,originY):
        ...
        data[data > 4] = 1 # 0 olanlar gidilebilir yer, 100 olanlar kesin engel
        print(data)
